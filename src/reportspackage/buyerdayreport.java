...
public class buyerdayreport extends javax.swing.JFrame {
    ...
    public void load_items()
    {
           try
           {
                    ...
                    ResultSet result = stat.executeQuery("select DISTINCT initial as uniquebuyer from buyer");
                    while(result.next())
                    {
                         buyer_name.addItem(result.getString("uniquebuyer"));
                    }
    ...
    private void initComponents() {
        ...
        generate_buyer_report.setText("G E N E R A T E    B U Y E R D A Y    R E P O R T");
        ...
        datepanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, datepanelLayout.createSequentialGroup()
                ...
                .addComponent(generate_buyer_report, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26))
        );

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 102, 102));
        jLabel1.setText("B U Y E R   D A Y   R E P O R T");
    ...
    private void generate_buyer_reportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generate_buyer_reportActionPerformed
        ...
        try
        {
            ...
            */
            ...
            int no_of_bags = (int)db.return_row_count("select sum(noofbags)as MAX_COUNT from manditransaction where date='"+dateString+"'", "MAX_COUNT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buyerdayreport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
